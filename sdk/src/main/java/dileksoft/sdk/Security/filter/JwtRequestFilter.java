...
public class JwtRequestFilter extends OncePerRequestFilter implements Serializable {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            response.getWriter().write("{\"timestamp\": " + System.currentTimeMillis() + ", \"status\": 401, \"error\": \"Unauthorized\", \"message\": \"Invalid Token - Token Geçersiz\", \"path\": \"" + request.getRequestURI() + "\"}");
        }
    }
