...
public interface EmptySpecs<T> {

    default <C extends Collection<?>> Specification<T> isEmpty(String entityParam) {
    ...
    default <C extends Collection<?>> Specification<T> isEmptyJoin (String joinedEntityPath, JoinType joinType, String entityParam) {
        return (root, criteriaQuery, criteriaBuilder) -> {
