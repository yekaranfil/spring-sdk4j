...
public interface LessThanOrEqualSpecs<T> {

    default <Y extends Comparable<Y>> Specification<T> lessThanOrEqual(String entityParam, Y value) {
    ...
    default <Y extends Comparable<Y>> Specification<T> lessThanOrEqualJoin (String joinedEntityPath, JoinType joinType,
