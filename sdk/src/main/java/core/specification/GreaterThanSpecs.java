...
public interface GreaterThanSpecs<T> {

    default <Y extends Comparable<Y>> Specification<T> greaterThan(String entityParam, Y value) {
    ...
    default <Y extends Comparable<Y>> Specification<T> greaterThanJoin (String joinedEntityPath, JoinType joinType,
