...
public interface NullSpecs<T> {

    default <C extends Collection<?>> Specification<T> isNull(String entityParam) {
    ...
    default <C extends Collection<?>> Specification<T> isNullJoin (String joinedEntityPath, JoinType joinType, String entityParam) {
