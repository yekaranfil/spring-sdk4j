...
public interface NotEmptySpecs<T> {

    default <C extends Collection<?>> Specification<T> isNotEmpty(String entityParam) {
    ...
    default <C extends Collection<?>> Specification<T> isNotEmptyJoin (String joinedEntityPath, JoinType joinType, String entityParam) {
        return (root, criteriaQuery, criteriaBuilder) -> {
