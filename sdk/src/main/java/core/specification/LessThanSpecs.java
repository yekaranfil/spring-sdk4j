...
public interface LessThanSpecs<T> {

    default <Y extends Comparable<Y>> Specification<T> lessThan(String entityParam, Y value) {
    ...
    default <Y extends Comparable<Y>> Specification<T> lessThanJoin (String joinedEntityPath, JoinType joinType,
